  ...
  const locate = target
    ...
    .addHelpText(
      ...
      [
        ...
        '',
        'An ordinary explicit start away from default_home_node is expected, not skew.',
        'External registrations are mechanism-born: their default_home_node remains governing policy.',
        '',
        'Exit codes:',
