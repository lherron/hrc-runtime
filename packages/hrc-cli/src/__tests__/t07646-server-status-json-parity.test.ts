...
const federatedAtomicStatus: ServerRuntimeStatus = {
  ...
  release: {
    ...
    aspContracts: [
      { name: 'agent-scope', version: '0.1.1-dev.20260825223449' },
      { name: 'cli-kit', version: '0.1.1-dev.20260825223449' },
      { name: 'spaces-aspc-protocol', version: '0.1.1-dev.20260825223449' },
      { name: 'spaces-harness-broker-protocol', version: '0.1.1-dev.20260825223449' },
      { name: 'spaces-harness-broker-client', version: '0.1.1-dev.20260825223449' },
      { name: 'spaces-runtime-contracts', version: '0.1.1-dev.20260825223449' },
    ],
