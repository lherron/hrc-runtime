...
export function mapRunRow(row: RunRow): HrcRunRecord {
  return {
    ...
    turnKey: row.turn_key ?? undefined,
    nativeTurnId: row.native_turn_id ?? undefined,
    nativeHarnessGeneration: row.native_harness_generation ?? undefined,
    nativeTurnAttempt: row.native_turn_attempt ?? undefined,
    initiatingInputId: row.initiating_input_id ?? undefined,
    ownershipConflictJson: row.ownership_conflict_json ?? undefined,
    observationState: row.observation_state ?? undefined,
    observedStartHrcSeq: row.observed_start_hrc_seq ?? undefined,
    operationId: row.operation_id ?? undefined,
    invocationId: row.invocation_id ?? undefined,
    dispatchedInputId: row.dispatched_input_id ?? undefined,
    brokerSubmissionId: row.broker_submission_id ?? undefined,
    brokerInputFencedAt: row.broker_input_fenced_at ?? undefined,
    brokerInputFenceReason: row.broker_input_fence_reason ?? undefined,
    dispatchIdempotencyKey: row.dispatch_idempotency_key ?? undefined,
    queueSnapshotId: row.queue_snapshot_id ?? undefined,
    queuedInputSeq: row.queued_input_seq ?? undefined,
