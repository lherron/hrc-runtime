...
export type HrcServerOptions = {
  ...
  /**
   * Cut interactive Pi TUI tmux dispatch over to the Harness Broker. Default on.
   *
   * Env override: `HRC_PI_TUI_TMUX_BROKER_ENABLED` (`0`/`false` disables).
   */
  piTuiTmuxBrokerEnabled?: boolean | undefined
  /**
   * Cut interactive Muse TUI tmux dispatch over to the Harness Broker. Default on.
   *
   * Env override: `HRC_MUSE_CLI_TMUX_BROKER_ENABLED` (`0`/`false` disables).
   */
  museCliTmuxBrokerEnabled?: boolean | undefined
  /**
