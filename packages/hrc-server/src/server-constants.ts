...
export const HRC_HEADLESS_MUSE_BROKER_ENABLED_ENV = 'HRC_HEADLESS_MUSE_BROKER_ENABLED'
...
export const HRC_MUSE_CLI_TMUX_BROKER_ENABLED_ENV = 'HRC_MUSE_CLI_TMUX_BROKER_ENABLED'
...
export const DEFAULT_HRC_TRANSCRIPT_INDEX_TICK_INTERVAL_MS = 2_000
