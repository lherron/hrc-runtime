/**
 * Real isolated-daemon smoke for T-06612: a summon carrying a missing project
 * checkout logs the named advisory refusal and still creates normally.
 */
...
describe('materialization capability on a live isolated daemon', () => {
  ...
  test('summon with missing checkout logs a named advisory refusal and still creates', async () => {
    await writeFile(
